...
\"\n\
checkout_executable TCLSH \"/home/naval/Documents/WSN_ns2.34/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/naval/Documents/WSN_ns2.34/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
\n\
Agent/RILAgent set packetSize_ 100\n\
\n\
Phy/WirelessCPhy set CPThresh_ 10.0\n\
Phy/WirelessCPhy set CSThresh_ 1.559e-11\n\
Phy/WirelessCPhy set RXThresh_ 3.652e-10\n\
Phy/WirelessCPhy set bandwidth_ 2e6\n\
Phy/WirelessCPhy set Pt_ 0.28183815\n\
Phy/WirelessCPhy set freq_ 914e+6\n\
Phy/WirelessCPhy set L_ 1.0  \n\
\n\
...
NRRRouting {\n\
set ragent [$self create-nrrrouting-agent $node]\n\
}\n\
ChargingRT {\n\
set ragent [$self create-chargingrt-agent $node]\n\
}\n\
default {\n\
eval $node addr $args\n\
...
\n\
Simulator instproc create-nrrrouting-agent { node gridSize} {\n\
set ragent [new Agent/NRRRouting [$node node-addr]]\n\
$self at 0.0 \"$ragent start\";\n\
$node set ragent_ $ragent\n\
return $ragent\n\
}\n\
\n\
Simulator instproc create-chargingrt-agent { node} {\n\
set ragent [new Agent/ChargingRT [$node node-addr]]\n\
$self at 0.0 \"$ragent start\";\n\
$node set ragent_ $ragent\n\
return $ragent\n\
}\n\
